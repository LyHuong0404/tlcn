    ...
    (e.prototype.init = function () {
            ...
            this.$element.bind('tabs-load', function (t) {
                ...
                a._setState(t),
                    a.options.startCollapsed === !0 ||
                        ('accordion' === a.options.startCollapsed && 'accordion' === a.state) ||
                        ((s = a._getStartTab()), a._openTab(t, s), a.options.load.call(this, t, s));
            }),
        ...
        (e.prototype._loadEvents = function () {
            for (
                        ...
                        a.preventDefault(),
                            o.disabled ||
                                ...
                                (e !== o || t._isCollapisble()) &&
                                    (t._closeTab(a, e), (e === o && t._isCollapisble()) || t._openTab(a, o, !1, !0)));
                    },
                    e = 0;
                e < this.tabs.length;
                e++
                ...
                this.tabs[e].anchor.on(t.options.event, { tab: t.tabs[e] }, a),
                    this.tabs[e].accordionAnchor.on(t.options.event, { tab: t.tabs[e] }, a);
        }),
        (e.prototype._getStartTab = function () {
            ...
            return (t = this._getTab(
                a >= 0 && !this._getTab(a).disabled
                    ? a
                    : this.options.active > 0 && !this._getTab(this.options.active).disabled
                    ? this.options.active
                    : 0,
            ));
        }),
        ...
        (e.prototype._openTab = function (s, a, e, o) {
            ...
            e && this._closeTab(s, this._getCurrentTab()),
                ...
                (a.active = !0),
                a.tab.removeClass(i.options.classes.stateDefault).addClass(i.options.classes.stateActive),
                a.accordionTab.removeClass(i.options.classes.stateDefault).addClass(i.options.classes.stateActive),
                i._doTransition(a.panel, i.options.animation, 'open', function () {
                    a.panel.removeClass(i.options.classes.stateDefault).addClass(i.options.classes.stateActive),
                        'accordion' !== i.getState() ||
                            !i.options.scrollToAccordion ||
                            (i._isInView(a.accordionTab) && 'default' === i.options.animation) ||
        ...
        (e.prototype._isCollapisble = function () {
            return (
                ('boolean' == typeof this.options.collapsible && this.options.collapsible) ||
                ('string' == typeof this.options.collapsible && this.options.collapsible === this.getState())
            );
        }),
